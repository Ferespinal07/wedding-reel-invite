  ...
  return (
    <section className="snap-section relative flex flex-col justify-center px-6 py-20">
      ...
      {submitted ? (
        ...
        >
          <p className="font-serif text-2xl italic text-gold">¡Confirmado!</p>
        ...
        >
          <div>
            <label className="text-[0.6rem] uppercase tracking-luxury text-muted-foreground">
              Nombre Completo
            </label>
            <input
              required
              type="text"
              className="mt-2 w-full border-b border-gold/40 bg-transparent py-2 text-sm tracking-wider text-foreground outline-none focus:border-gold"
            />
          </div>
                ...
                <button
                  ...
                  className={`border py-3 text-[0.65rem] uppercase tracking-luxury transition-all ${
                    attending === v
                      ...
                      : "border-gold/40 text-foreground/80 hover:border-gold"
                  }`}
                >
          ...
          <div>
            ...
            <textarea
              rows={2}
              className="mt-2 w-full resize-none border-b border-gold/40 bg-transparent py-2 text-sm tracking-wider text-foreground outline-none focus:border-gold"
            />
          </div>

          <button
            type="submit"
            className="w-full border border-gold bg-gold/10 py-4 text-[0.7rem] uppercase tracking-luxury text-gold transition-colors hover:bg-gold hover:text-primary-foreground"
          >
            Enviar Confirmación
          </button>
        </motion.form>
